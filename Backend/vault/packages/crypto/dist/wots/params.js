 ...
 */
export function computeWOTSParams(w = 16, n = 32) {
 ...
 */
export function getRecommendedParams(profile) {
    switch (profile) {
        case 'fast':
 ...
 */
export function signatureSize(params) {
    return params.len * params.n;
}
/**
 * Calculate public key size in bytes
 */
export function publicKeySize(params) {
    return params.len * params.n;
}
/**
 * Calculate private key size in bytes
 */
export function privateKeySize(params) {
    return params.len * params.n;
}
