...
import { StealthAddressing } from './stealth.js';
import { IntentEncryption } from './encryption.js';
/**
 * SIP Protocol Client
 *
...
export class SIPClient {
    ...
    async createIntent(params) {
        ...
        const signature = this.wots.sign(privateKey, messageHash);
        ...
        // Encrypt intent
        const encryptedIntent = IntentEncryption.encryptIntent(intentBytes, this.stealthKeys.metaAddress.viewingPubKey, privacyLevelStr, this.config.viewingKey);
