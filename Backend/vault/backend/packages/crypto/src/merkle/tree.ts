...
import { hashConcat, hash as hashFn, bytesEqual } from '../hash.js';
...
export class MerkleTree {
  ...
  private constructor(levels: Hash[][]) {
    this.levels = levels;
 ...
 */
export function computeRootFromProof(leaf: Hash, proof: MerkleProof): Hash {
  let current = leaf;
